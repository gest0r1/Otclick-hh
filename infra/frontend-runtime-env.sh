...
replace_token '__OTCLICK_SUPABASE_URL__' "${NEXT_PUBLIC_SUPABASE_URL:?NEXT_PUBLIC_SUPABASE_URL is required}"
replace_token '__OTCLICK_SUPABASE_ANON_KEY__' "${NEXT_PUBLIC_SUPABASE_ANON_KEY:?NEXT_PUBLIC_SUPABASE_ANON_KEY is required}"
replace_token '__OTCLICK_API_URL__' "${NEXT_PUBLIC_API_URL:?NEXT_PUBLIC_API_URL is required}"
